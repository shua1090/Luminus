...
public:
    ...
    virtual void enterFunc_call(LuminusParser::Func_callContext * /*ctx*/) override {}

    virtual void exitFunc_call(LuminusParser::Func_callContext * /*ctx*/) override {}
    ...
    virtual void enterMemberAccessExpression(LuminusParser::MemberAccessExpressionContext * /*ctx*/) override {}

    virtual void exitMemberAccessExpression(LuminusParser::MemberAccessExpressionContext * /*ctx*/) override {}
  ...
  virtual void enterMethodAccessExpression(LuminusParser::MethodAccessExpressionContext * /*ctx*/) override { }
  virtual void exitMethodAccessExpression(LuminusParser::MethodAccessExpressionContext * /*ctx*/) override { }
